...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    slugs: {
      ...
      ru: 'izmenenie-razmera-izobrazheniy',
    },
    icon: '📏',
  ...
  },
  {
    ...
    icon: '🔑',
    keywords: ['jwt', 'token', 'json web token', 'decode jwt', 'jwt payload', 'jwt header'],
  },
  {
    id: 'regex-tester',
    category: 'text',
    ...
    icon: '🔍',
    keywords: ['regex', 'regular expression', 'pattern', 'regex tester', 'regexp'],
  },
  {
    id: 'text-diff',
    category: 'text',
    ...
    icon: '📊',
    keywords: ['diff', 'compare text', 'text diff', 'compare', 'difference', 'side by side'],
  },
];
