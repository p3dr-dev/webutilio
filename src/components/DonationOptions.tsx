    ...
    <div className="max-w-4xl mx-auto space-y-8 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">{t('donation.title')}</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
             <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-white">{t('donation.international')}</h3>
             </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
             <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-white">{t('donation.crypto')}</h3>
             </div>
